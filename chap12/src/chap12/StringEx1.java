...
/*
 * String 클래스 예제
 * 1. String 클래스는 유일하게 대입연산자로 객체 생성이 가능함. + 연산자 사용이 가능함
 *    다른 클래스의 객체는 new 클래스명() 형태로  객체 생성이 됨.
 * 2. final 클래스임
 * 3. + 연산으로 기본형을 String 형으로 형변환 가능
 * 
 * 대입연산자로 생성하면 같은객체,같은내용 >> 스택영역에 생성됨
 * new 클래스명()으로 생성하면 다른객체,같은내용 >>힙영역에 생성됨(번지가 달라짐)
 */
