package chap8;
import java.util.Date; // Date 대신 * 사용시 java.util 모든것 가져다 쓸수있음
import chap8.packtest.Pack2; // 밑에 패키지명 생략할때 씀
/*
 * package : 클래스들의 모임
 *    클래스 이름은 패키지명을 포함한다.
